...
@section('content')
    <main id="main" class="main" style="background-color:#f75c41">
        ...
        <div class="pagetitle">
            <h1 class="text-white">PREDIKSI HARGA SAHAM TERTINGGI REGRESI LINEAR</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html" class="text-white">Home</a></li>
                    <li class="breadcrumb-item active text-white">Prediksi Harga Regresi</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive table-borderless datatable">
                                ...
                                @foreach($prediksi_data_7 as $prediksi)
                                    <tr>
                                    <td>{{ $prediksi['Date'] }}</td>
                                    @foreach($prediksi['Predictions'] as $harga)
                                        <td>{{ $harga }}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
