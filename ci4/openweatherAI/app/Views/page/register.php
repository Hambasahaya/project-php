    ...
    <div class="box-login">
        ...
        <div class="container">
            <div class="login-page" id="login">
                <h4 class="header-login text-center">Register</h4>
                <form action="/register" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" name="bb">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" name="tb">
                    </div>
                    <div class="mb-3">
